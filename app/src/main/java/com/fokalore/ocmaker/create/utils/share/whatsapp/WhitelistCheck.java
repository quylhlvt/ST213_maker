package com.fokalore.ocmaker.create.utils.share.whatsapp;
...
public class WhitelistCheck {
    public static final String CONTENT_PROVIDER_AUTHORITY = "com.fokalore.ocmaker.create.utils.share.whatsapp.StickerContentProvider";
